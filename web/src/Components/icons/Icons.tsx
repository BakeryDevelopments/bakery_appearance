...
export const IconPalette: FC<IconProps> = ({ size = 24, style }) => {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" xmlns="http://www.w3.org/2000/svg" style={style}>
      <path d="M12 21a9 9 0 0 1 0-18c4.97 0 9 3.582 9 8c0 1.06-.474 2.078-1.318 3.12.98.577 1.852 1.297 2.506 2.093C23.694 11.388 24 9.770 24 8c0-6.627-5.373-12-12-12S0 1.373 0 8s5.373 12 12 12z"></path>
...
export const IconAdjustments: FC<IconProps> = ({ size = 24, style }) => {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" xmlns="http://www.w3.org/2000/svg" style={style}>
      <path d="M4 12a8 8 0 0 1 15.387 -2m0 11.613a8 8 0 0 1 -15.387 2m15.387 -11.613a8.111 8.111 0 0 0 -7.387 -4a8.111 8.111 0 0 0 -7.387 4"></path>
...
export const IconHanger: FC<IconProps> = ({ size = 24, style }) => {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" xmlns="http://www.w3.org/2000/svg" style={style}>
      <path d="M9 5a3 3 0 0 0 -3 3v7a3 3 0 0 0 3 3h6a3 3 0 0 0 3 -3v-7a3 3 0 0 0 -3 -3h-6z"></path>
      <path d="M9 1a1 1 0 0 0 -1 1v2a1 1 0 0 0 2 0v-2a1 1 0 0 0 -1 -1z"></path>
      <path d="M15 1a1 1 0 0 0 -1 1v2a1 1 0 0 0 2 0v-2a1 1 0 0 0 -1 -1z"></path>
    </svg>
  );
};
...
export const IconMars: FC<IconProps> = ({ size = 24, style, color }) => {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color || "currentColor"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" xmlns="http://www.w3.org/2000/svg" style={style}>
      <path d="M9 10c-1.657 -1.657 -1.657 -1.657 0 -3.314c1.657 -1.657 1.657 -1.657 3.314 0"></path>
